...
def createDaemon(logfile):
    ...
    os.open(DEV_NULL, os.O_RDWR)	# standard input (0)

    log_fd = os.open(logfile, os.O_WRONLY|os.O_APPEND|os.O_CREAT, 0640)	

    # Duplicate standard input to standard output and standard error.
    os.dup2(log_fd, sys.stdout.fileno()) # standard output (1)
    os.dup2(log_fd, sys.stderr.fileno()) # standard error (2)
